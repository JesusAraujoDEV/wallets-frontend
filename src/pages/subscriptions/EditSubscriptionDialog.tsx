...
export function EditSubscriptionDialog({ open, onOpenChange, form, onSubmit, isPending, accounts, categories, activeDebts }: {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] sm:w-full max-w-md sm:max-w-lg max-h-[85vh] overflow-y-auto rounded-xl">
        ...
        <form className="space-y-4" onSubmit={onSubmit}>
          <SubscriptionBasicFields form={form} idPrefix="edit" accounts={accounts} categories={categories} activeDebts={activeDebts} />
          <SubscriptionScheduleFields form={form} idPrefix="edit" />
